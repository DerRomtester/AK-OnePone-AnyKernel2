...
echo 65 > /sys/class/misc/mako_hotplug_control/load_threshold;
echo 5 > /sys/class/misc/mako_hotplug_control/high_load_counter;
echo 1728000 > /sys/devices/system/cpu/cpufreq/conservative/input_boost_freq;
echo 1574400 > /sys/devices/system/cpu/cpufreq/interactive/hispeed_freq;
